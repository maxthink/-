...
return  array(
    ...
    //微信内容存放设置
    'WXMEDIA'=>array(
        'TALKING'       => 'wxmedia/talking/',      //微信聊天记录用户图片存放目录, 按照用户的openid区分
        'TALKING_KF_IMAGE' => 'wxmedia/talking/KF/', //微信聊天客服用的图片存放目录, 所有客服聊天用图片放一起?
        'NEWS_COVER'    => 'wxmedia/news/cover/',   //图文消息封面图片存放位置
        
        'TEMP'          => 'wxmedia/temp/',         //临时素材存放位置, 包括客服的聊天图片
        'QR'            => 'wxmedia/qr/',           //二维码存放位置
    ),
    ...
    'APP_SUB_DOMAIN_RULES'  => array(   
		...
		'm'=>array('M/'),  // test域名指向Test分组
		'wx'=>array('Wx/')
    ), // 子域名部署规则
    'APP_SUB_DOMAIN_DENY'   => array(), //  子域名禁用列表
    'APP_GROUP_LIST'        => 'Home,Admin,M,Wx',      // 项目分组设定,多个组之间用逗号分隔,例如'Home,Admin'
    'APP_GROUP_MODE'        =>  1,  // 分组模式 0 普通分组 1 独立分组
    'APP_GROUP_PATH'        =>  'Moudules', // 分组目录 独立分组模式下面有效
    'ACTION_SUFFIX'         =>  '', // 操作方法后缀
    'BASE_PATH'             => dirname(dirname(dirname(__FILE__))).'/',	//获取网站的根目录

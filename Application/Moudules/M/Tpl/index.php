...
<body>
	<div class="cw-body">
		<div class="fb-title"><div><p><span>新闻 > 列表 </span></p></div></div>
		<div class="fb-body">
						...
						<div class="body-table-div">
							...
							<div class="handle-btns">
								...
								<!-- <form action="/admin/index.php">
									<span>标题</span>
									<input class="textinput" type="text" value="" name="title" size="10" />
							...
							action="true"
							datasource="list"
							show="id:编号,catid|showCategory:类别,aid|showArea:地区,title:标题:editData,create_time:添加时间,status|getStatus:状态" 

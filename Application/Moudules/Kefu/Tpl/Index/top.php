...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title></title>
        <link href="__PUBLIC__/kefu/style/style.css" rel="stylesheet" type="text/css">
    ...
    <body style="background:#99A2B3;padding:0">
        <div class="cw-header">
            <div class="fh-top">
                ...
                <div class="fht-navs">
                    <div class="active"> 
                        <p><a href='{:U("Talking/index")} ' target="leftFrame">聊天窗口</a></p>
                    </div>
                    <div class=""> 
                        <p><a href='{:U("Index/left")} ' target="leftFrame">消息记录</a></p>
                    </div>
                </div>
            </div>

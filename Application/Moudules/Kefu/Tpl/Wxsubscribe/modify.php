...
<body>
<div class="cw-body">
    <div class="fb-title"><div><p><span>自动回复 > <php>if(isset($vo['id'])) echo '编辑'; else echo '添加'; </php></if></span></p></div></div>
    <div class="fb-body">
        <form method='post' id="form1" name="form1" action="{:U(MODULE_NAME.'/modify')}">
            <table cellpadding="4" cellspacing="0" cellspacing="1"  border="0" class="table-form">
                ...
                <tr>
                    ...
                    <td><textarea type="text"  name="content"  style=" font-size: 18px;" cols="90" rows="20" />{$vo.content}</textarea></td>
                </tr>

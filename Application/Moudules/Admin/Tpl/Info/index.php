...
<body>
	<div class="cw-body">
		<div class="fb-title"><div><p><span>信息 > 列表 </span></p></div></div>
		<div class="fb-body">
				...
				<tr>
					<td class="body-table-td">
						<div class="body-table-div">
							...
							action="true"
							datasource="list"
							show="id:编号,catid|showCategory:类别,aid|showArea:地区,title:标题:editData,create_time:添加时间,status|getStatus:状态,recommend|getStatus:推荐" 

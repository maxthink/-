...
<div class="cw-body">
	<div class="fb-title"><div><p><span>借款 > 编辑</span></p></div></div>
		<div class="fb-body">
			...
			<table cellpadding="4" cellspacing="0" cellspacing="1"  border="0" class="table-form">
				...
				<tr>
					...
					<td><input class="Wdate" type="text" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})" name="time"  value="{$vo.time}" /></td>
				</tr>

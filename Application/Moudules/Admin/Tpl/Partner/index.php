...
<body>
	<div class="cw-body">
		<div class="fb-title"><div><p><span>{$Think.const.MODULE_NAME} > {$Think.const.ACTION_NAME} </span></p></div></div>
		<div class="fb-body">
				...
				<tr>
					<td class="body-table-td">
						<div class="body-table-div">
							...
							action="true"
							datasource="list"
							show="id:编号,name:名称:editdata,logo|getUploadImg:{$logo}:LOGO,status|getStatus:状态" 

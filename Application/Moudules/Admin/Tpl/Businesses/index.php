...
<body>
	<div class="cw-body">
		<div class="fb-title"><div><p><span>商家 > 列表 </span></p></div></div>
		<div class="fb-body">
					...
					<td class="body-table-td">
						<div class="body-table-div">
							...
							<div class="handle-btns">
								...
								<!-- --><form action="/admin/businesses/index">
									<span>商家名</span>
									<input class="textinput" type="text" value="{$search_str}" name="search_str"  size="10" />
									<input class="submit_btn" type="submit" value="搜索" />
									<input type="hidden" name="m" value="businesses" />
							...
							action="true"
							datasource="list"
							show="id:编号,catid|showCategory:类别:showCategory,aid|showArea:地区:showArea,name:商家名:editData,address:地址,create_time:添加时间,status|getStatus:状态,recommend|getStatus:推荐" 
							actionlist="editData:编辑,showData:详情,deleteData:删除:id,setStatus:禁用|恢复,setRecommend:推荐|取消" />

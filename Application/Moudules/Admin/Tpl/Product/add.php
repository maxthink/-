...
<div class="cw-body">
	<div class="fb-title"><div><p><span>产品 &gt; 添加 </span></p></div></div>
	<div class="fb-body">
		<form method='post' id="form" name="form"  action="{:U(MODULE_NAME.'/save')}" >
			<table cellpadding="4" cellspacing="0" cellspacing="1"  border="0" class="table-form">

				<tr>
					<th  width="200">名称</th> <td><textarea name="title" cols="80" rows="2" ></textarea></td>
				</tr>
				...
				<tr>
					...
					<td><input class="Wdate" type="text" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})" name="time"  value="" /></td>
				</tr>
				...
				<tr>
					...
					<td>
						...
						下线<input type="radio"  name="status" value="0" checked />
					</td>
				</tr>

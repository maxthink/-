...
<body>
	<div class="cw-body">
		<div class="fb-title"><div><p><span>放款 > 列表 </span></p></div></div>
		<div class="fb-body">
				...
				<tr>
					<td class="body-table-td">
						<div class="body-table-div">
							...
							action="true"
							datasource="list"
							show="username:用户姓名,money:放款金额(万),repayment:还款方式,deadline:放款期限(月),timeline:填表时间,status|getStatus:是否审核通过" 

...
<div class="cw-body">
	<div class="fb-title"><div><p><span>放款 > 编辑</span></p></div></div>
		<div class="fb-body">
			...
			<table cellpadding="4" cellspacing="0" cellspacing="1"  border="0" class="table-form">
				...
				<tr>
					...
					<td><input type="text"  name="username"  value="{$vo.username}" /></td>
                                ...
                                <tr>
                                    <th class="td_right">您来自哪里 :</th>
                                    <td colspan="2">&nbsp;&nbsp;&nbsp;
                                        省: <select name="collateral_pro" id="province" onchange="getList(this.value,'city',1)"><option value="1">北京</option><option value="2">天津</option><option value="3">河北</option><option value="4">山西</option><option value="5">内蒙古</option><option value="6">辽宁</option><option value="7">吉林</option><option value="8">黑龙江</option><option value="9">上海</option><option value="10">江苏</option><option value="11">浙江</option><option value="12">安徽</option><option value="13">福建</option><option value="14">江西</option><option value="15">山东</option><option value="16">河南</option><option value="17">湖北</option><option value="18">湖南</option><option value="19">广东</option><option value="20">广西</option><option value="21">海南</option><option value="22">重庆</option><option value="23">四川</option><option value="24">贵州</option><option value="25">云南</option><option value="26">西藏</option><option value="27">陕西</option><option value="28">甘肃</option><option value="29">青海</option><option value="30">宁夏</option><option value="31">新疆</option><option value="32">香港</option><option value="33">澳门</option><option value="34">台湾</option></select>&nbsp;&nbsp;&nbsp;
                                        市: <select name="collateral_city" id="city" disable="disable"><option value="35">东城</option><option value="36">西城</option><option value="37">崇文</option><option value="38">宣武</option><option value="39">朝阳</option><option value="40">丰台</option><option value="41">石景山</option><option value="42">海淀</option><option value="43">门头沟</option><option value="44">房山</option><option value="45">通州</option><option value="46">顺义</option><option value="47">昌平</option><option value="48">大兴</option><option value="49">怀柔</option><option value="50">平谷</option><option value="51">延庆</option><option value="52">密云</option></select>
                                    </td>
                                </tr>

				<tr>
					<th  width="200">放款金额</th>
					<td><input type="text"  name="money"  value="{$vo.money}" />万</td>
                                ...
                                <tr>
                                    <th  width="200">放款利息(年息) :</th>
                                    <td><input type="text" name="interest" id="interest" value="{$vo.interest}" >%</td>
                                </tr>
				
				<tr>
					<th  width="200">放款期限</th>
					<td><input type="text"  name="deadline"  value="{$vo.deadline}" />个月</td>
				</tr>
                                
                                <tr>
                                    <th class="td_right">抵押物要求 :</th>
                                    <td><input type="text" name="collateral" id="collateral" value="{$vo.collateral}" ><span> 比如要求房产或车辆抵押 </span></td>                                    
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2"><textarea name="comment" rows="6" cols="55">{$vo.comment}</textarea></td>
                                </tr>
